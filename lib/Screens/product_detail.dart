                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        LinearPercentIndicator(
                          ...
                          lineHeight: 10.0,
                          percent: ((double.parse(productModel.protein!) / 30) *
                                  100) /
                              100,
                          backgroundColor: Colors.grey,
                          barRadius: const Radius.circular(16),
                          progressColor: const Color.fromARGB(255, 59, 82, 255),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        LinearPercentIndicator(
                          ...
                          lineHeight: 10.0,
                          percent:
                              ((double.parse(productModel.fats!) / 30) * 100) /
                                  100,
                          backgroundColor: Colors.grey,
                          barRadius: const Radius.circular(16),
                          progressColor: const Color.fromARGB(255, 59, 82, 255),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        LinearPercentIndicator(
                          ...
                          lineHeight: 10.0,
                          percent:
                              ((double.parse(productModel.calories!) / 300) *
                                      100) /
                                  100,
                          backgroundColor: Colors.grey,
                          barRadius: const Radius.circular(16),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        LinearPercentIndicator(
                          ...
                          lineHeight: 10.0,
                          percent:
                              ((double.parse(productModel.carbohydrate!) / 20) *
                                      100) /
                                  100,
                          backgroundColor: Colors.grey,
                          barRadius: const Radius.circular(16),
